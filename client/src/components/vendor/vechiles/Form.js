...
class Form extends React.Component{
    ...
    componentDidMount(){
        axios.get("http://localhost:3005/vendor/vehicles/all",{
    ...
    handleSubmit = (e) => {
        e.preventDefault()
        const { vehicle, number_plate, pricing_intercity_km, pricing_intracity_km, helper_rate } = this.state
        const formdata = {
    ...
    render(){
        ...
        const { vehiclesLoaded, vehicle, number_plate, vehicleOptions, pricing_intercity_km, pricing_intracity_km, helper_rate, showVehicle } = this.state
        return (
            <div className="row">
                    ...
                    { showVehicle.status && 
                        <div className="viewBox">
                            <ul>
                                ...
                                <li><img src={`http://localhost:3005/uploads/${showVehicle.image}`} alt="" style={{width: '100%', marginTop: '20px'}} /></li>
                            </ul>
                        </div>
                    }
                </div>
