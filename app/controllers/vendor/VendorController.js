...
//localhost:3000/vendor
router.put("/",userAuth,vendorAccess,upload.single('aadhar'),function(req,res){
    const { address, pincode, bank_account_number, bank_account_ifsc, aadhar} = req.body
