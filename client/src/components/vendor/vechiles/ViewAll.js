...
class ViewAll extends React.Component {
    ...
    componentDidMount(){
        ...
        axios.get("http://localhost:3005/vendor/vehicles",{
    ...
    handleDelete = (id) => {
        ...
        if(window.confirm("Are you sure ?")){
            axios.delete(`http://localhost:3005/vendor/vehicles/${id}`,{
                    headers: { 'x-auth': user.token }
                })
                .then(res => {
                    if(res.data.success){
                                ...
                                <table className="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colSpan="1">Intercity Pricing</th>
                                            <th colSpan="1">Intracity Pricing</th>
